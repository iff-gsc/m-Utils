...
%
% Syntax: struct2bus(derivatives, 'BusDerivative')
%
...
% an ID. This can be done as follows: Syntax: struct2bus(derivatives,
...
% Syntax: struct2bus(derivatives, 'BusDerivative', 'Differentiate', 'dim')
%
...
%'derivatives_dim' with elements 'row' and 'cols'.  Now, struct2bus(newStruct,
...
% struct2bus(derivatives, 'BusDerivative', 'ID', 4, ...
...
function struct2bus( s, BusName, varargin )
    ...
    assignin('base', [ BusName, charID ], BusObject);
end
